...
import java2.Product;

public class FinalPracticalTest {
    ...
    { System.out.println("1. Add a new product to the Store.");
        ...
        p.updatePrice//Students write here appropriate statements to complete this function
        } else {
        ...
        o.printByOrderId//Students write here appropriate statements to complete this function
        } else {
        ...
        o.printByCustomerId//Students write here appropriate statements to complete this function
        } else {
